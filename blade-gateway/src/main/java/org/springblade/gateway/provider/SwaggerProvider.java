...
public class SwaggerProvider implements SwaggerResourcesProvider {
	...
	static {
		...
		routeMap.put("blade-platform", "安标模块");
		routeMap.put("blade-manage", "经营模块");
		routeMap.put("blade-doc", "doc模块");
		routeMap.put("blade-upload", "附件");
		routeMap.put("blade-user", "人员模块");
		routeMap.put("blade-baojing", "报警模块");
		routeMap.put("blade-gps", "GPS报警模块");
	}
