...
import org.springblade.platform.yingjijiuyuan.service.IYingjiyanlianService;
...
@RestController
@AllArgsConstructor
@RequestMapping("/platform/yingjiyanlian")
...
public class YingjiyanlianController {
    ...
    @PostMapping("/list")
	@ApiLog("分页-应急演练")
    @ApiOperation(value = "分页-应急演练", notes = "传入VehiclePage", position = 1)
    public R<YingjiyanlianPage<YingjiyanlianVO>> list(@RequestBody YingjiyanlianPage yingjiyanlianpage) {
    ...
    public R<YingjiyanlianVO> detail(@ApiParam(value = "主键id", required = true) @RequestParam String id) {
