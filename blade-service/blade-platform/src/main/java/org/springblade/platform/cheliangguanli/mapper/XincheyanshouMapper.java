 ...
 *  Mapper 接口
 */
public interface XincheyanshouMapper extends BaseMapper<Xincheyanshou> {
	 ...
	 * @return
	 */
	List<XincheyanshouVO> selectXincheyanshouPage(IPage page, XincheyanshouVO xincheyanshou);
	 ...
	 * @return
	 */
	List<XincheyanshouVO> selectPageList(XincheyanshouPage Page);
	/**
	 * 统计
	 * @param
	 * @return
	 */
	int selectTotal(XincheyanshouPage Page);
