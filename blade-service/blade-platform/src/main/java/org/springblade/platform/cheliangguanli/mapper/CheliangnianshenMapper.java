 ...
 *  Mapper 接口
 */
public interface CheliangnianshenMapper extends BaseMapper<Cheliangnianshen> {
	 ...
	 * @return
	 */
	List<CheliangnianshenVO> selectCheliangnianshenPage(IPage page, CheliangnianshenVO cheliangnianshen);
	/**
	 * 自定义分页
	 * @param
	 * @return
	 */
	List<CheliangnianshenVO> selectPageList(CheliangnianshenPage Page);
	/**
	 * 统计
	 * @param
	 * @return
	 */
	int selectTotal(CheliangnianshenPage Page);
