 ...
 *  服务类
 */
public interface IWeixiucailiaomingxiService extends IService<Weixiucailiaomingxi> {
	 ...
	 * @return
	 */
	IPage<WeixiucailiaomingxiVO> selectWeixiucailiaomingxiPage(IPage<WeixiucailiaomingxiVO> page, WeixiucailiaomingxiVO weixiucailiaomingxi);
	 ...
	 * @return
	 */
	WeixiucailiaomingxiPage<WeixiucailiaomingxiVO> selectPageList(WeixiucailiaomingxiPage Page);
}
