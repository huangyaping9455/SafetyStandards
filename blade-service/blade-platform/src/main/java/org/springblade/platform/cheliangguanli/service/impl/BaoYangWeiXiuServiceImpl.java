...
import org.springblade.platform.cheliangguanli.mapper.BaoYangWeiXiuMapper;
...
@Service
@AllArgsConstructor
public class BaoYangWeiXiuServiceImpl extends ServiceImpl<BaoYangWeiXiuMapper, BaoYangWeiXiu> implements IBaoYangWeiXiuService {

	private BaoYangWeiXiuMapper mapper;


	@Override
	public BaoYangWeiXiuVO selectByIds(String id) {
	...
	@Override
	public BaoYangWeiXiuPage<BaoYangWeiXiuVO> selectPageList(BaoYangWeiXiuPage Page) {
		...
		if (pagetotal < Page.getCurrent()) {
			...
			List<BaoYangWeiXiuVO> vehlist = mapper.selectPageList(Page);
			return (BaoYangWeiXiuPage<BaoYangWeiXiuVO>) Page.setRecords(vehlist);
		}
	}
}
