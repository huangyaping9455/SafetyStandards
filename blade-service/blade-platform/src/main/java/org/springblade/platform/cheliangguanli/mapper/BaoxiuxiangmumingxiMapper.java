 ...
 *  Mapper 接口
 */
public interface BaoxiuxiangmumingxiMapper extends BaseMapper<Baoxiuxiangmumingxi> {
	 ...
	 * @return
	 */
	List<BaoxiuxiangmumingxiVO> selectBaoxiuxiangmumingxiPage(IPage page, BaoxiuxiangmumingxiVO baoxiuxiangmumingxi);
	 ...
	 * @return
	 */
	List<BaoxiuxiangmumingxiVO> selectPageList(BaoxiuxiangmumingxiPage Page);
	/**
	 * 统计
	 * @param
	 * @return
	 */
	int selectTotal(BaoxiuxiangmumingxiPage Page);
