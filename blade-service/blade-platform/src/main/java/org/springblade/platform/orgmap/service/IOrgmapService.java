 ...
 */
package org.springblade.platform.orgmap.service;
 ...
 *  服务类
 */
public interface IOrgmapService extends IService<Orgmap> {
	 ...
	 * @return
	 */
	IPage<OrgmapVO> selectOrgmapPage(IPage<OrgmapVO> page, OrgmapVO orgmap);
