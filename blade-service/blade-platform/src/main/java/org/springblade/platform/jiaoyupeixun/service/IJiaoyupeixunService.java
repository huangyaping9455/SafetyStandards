 ...
 * @since 2019-04-25
 */
public interface IJiaoyupeixunService extends IService<Jiaoyupeixun> {
	 ...
	 * @return
	 */
	IPage<JiaoyupeixunVO> selectJiaoyupeixunPage(IPage<JiaoyupeixunVO> page, JiaoyupeixunVO jiaoyupeixun);
	 ...
	 * @return
	 */
	JiaoyupeixunPage<JiaoyupeixunVO> selectPageList(JiaoyupeixunPage jiaoyupeixunPage);
