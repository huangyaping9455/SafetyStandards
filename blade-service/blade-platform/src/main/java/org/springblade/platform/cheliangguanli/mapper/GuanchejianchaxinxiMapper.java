 ...
 *  Mapper 接口
 */
public interface GuanchejianchaxinxiMapper extends BaseMapper<Guanchejianchaxinxi> {
	 ...
	 * @return
	 */
	List<GuanchejianchaxinxiVO> selectGuanchejianchaxinxiPage(IPage page, GuanchejianchaxinxiVO guanchejianchaxinxi);
	 ...
	 * @return
	 */
	List<GuanchejianchaxinxiVO> selectPageList(GuanchejianchaxinxiPage Page);
	/**
	 * 统计
	 * @param
	 * @return
	 */
	int selectTotal(GuanchejianchaxinxiPage Page);
