...
public class RegistryConfiguration implements WebMvcConfigurer {
	...
	public SecureRegistry secureRegistry() {
		...
		secureRegistry.excludePathPatterns("/sys/**");
		secureRegistry.excludePathPatterns("/dict/**");
		secureRegistry.excludePathPatterns("/dept/**");
		secureRegistry.excludePathPatterns("/dict/getByCode");
		secureRegistry.excludePathPatterns("/menu/**");
