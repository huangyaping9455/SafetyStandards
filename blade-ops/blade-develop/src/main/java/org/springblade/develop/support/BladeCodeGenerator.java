...
public class BladeCodeGenerator {
	 ...
	 * 代码生成的包名
	 */
	private String packageName = "org.springblade.demo";
	/**
	 * 代码后端生成的地址
	 */
	 ...
	 * 需要去掉的表前缀
	 */
	private String[] tablePrefix = {"baobiao_"};
	/**
	 * 需要生成的表名(两者只能取其一)
	 */
	private String[] includeTables = {"baobiao_alarmvehdailyreport"};
	/**
	 * 需要排除的表名(两者只能取其一)
	 */
	...
	public String getOutputDir() {
		return (Func.isBlank(packageDir) ? System.getProperty("user.dir") + "/blade-service/blade-baojing" : packageDir) + "/src/main/java";
	}
