...
public class IdCardUtil {
	...
	public static void main(String[] args) {
		String idCard = "511923199501179455";
		...
		//通过身份证获取生日日期
		System.out.println(dateFormat2.format(getBirthDate(idCard)));

		//通过身份证获取性别
		System.out.println(getGender(idCard));

		//通过身份证获取生肖
		System.out.println(getZodiacById(idCard));

		//通过身份证获取对应的天干地支
		System.out.println(getChineseEraById(idCard));
